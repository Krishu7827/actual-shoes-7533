...
import toothWhite from "./tooth-whitening .png"
import DentalExamine from "./examine.png"
import Filling from "./contact-form.png"
import Dental_X_Ray from "./x-ray.png"
import Root_Canal from "./root-canal.png"
import Job from "./Screenshot_2023-08-25_164050-removebg-preview.png"

export function TopService() {

    return (
        <div>
            <h3 className="TopServiceHeading">Top-searched specialties</h3>
            <div className="TopService">
                <div>
                    <img src="https://cdn-icons-png.flaticon.com/128/6201/6201048.png" alt="teeth cleaning" />
                    <p>Teeth Cleaning</p>
                </div>
                <div>
                    <img src={toothWhite} alt="teeth cleaning" />
                    <p>Teeth Whitening</p>
                </div>
                <div>
                    <img src={DentalExamine} alt="teeth cleaning" />
                    <p>Dental Examination</p>
                </div>
                <div>
                    <img src={Filling} alt="teeth cleaning" />
                    <p>Fillings</p>
                </div>

                <div>
                    <img src={Dental_X_Ray} alt="teeth cleaning" />
                    <p>Dental X Ray</p>
                </div>
                <div>
                    <img src={Root_Canal} alt="teeth cleaning" />
            ...
            <div className="ReviewBook">
                <h2 className="ReviewBookHeading">Let’s get you a doc who gets you</h2>
                <br />
                <br />
                <br />
                <br />
                <div className="ReviewBookContainer">
                    <div>
                        <img src="https://d1uhlocgth3qyq.cloudfront.net/ValuePropsBook___893a8.svg" alt="" />
                        <h4>Book an appointment <br /> today, online</h4>
                        <br />
                    ...
                    <div>
                        <img src="https://d1uhlocgth3qyq.cloudfront.net/ValuePropsReviews___d6977.svg" alt="" />
                        <h4>Read reviews from <br /> users</h4>
                        <br />
                        <div className="button">
                            <p>See Review</p>
                        </div>
            ...
            <div className="GetApp">
                <div className="GetApp_leftSide">
                    <h3>Thousands of providers.<br />One app.</h3>
                ...
                <div className="GetApp_rightSide">
                   
                  <img src="https://d1uhlocgth3qyq.cloudfront.net/zocdoc-app-in-hand-1344w___5f217.png" alt="" />
                </div>
            </div>
           <br />
           <br />
           <br />
           <br />
           <div className="MainDivPartnerWithDentDesk">
           <div className="PartnerWithDentDesk">
           
              <div className="Partner_leftSide">
              <p className="intro">DentDesk for health systems</p>
              <h3>We’re trusted by top <br /> health systems</h3>
              <div> <a href="" className="eXnnyV">Partner with DentDesk</a>  </div>
              </div>
              <div className="Partner_rightSide">
              <div>
                <img src="https://d1uhlocgth3qyq.cloudfront.net/medstar-health-logo___baa3b.svg" alt="" />
              </div>

              <div>
                <img src="https://d1uhlocgth3qyq.cloudfront.net/mountsinai-logo___c1387.svg" alt="" />
              </div>

              <div>
                <img src="https://d1uhlocgth3qyq.cloudfront.net/tufts-medical-logo___5e76f.svg" alt="" />
              </div>

              <div>
                <img src="https://d1uhlocgth3qyq.cloudfront.net/montefiore-logo___1361e.svg" alt="" />
              </div>
         ...
         <div className="MainJobInDentDesk">
           <div className="JobsInDentDesk">
            <div className="JobInDentDesk-leftSide">
                <p className="intro">DentDesk JOBS</p>
                <h3>Join us, and help transform <br />
                 healthcare for everyone.
                </h3>
                <div >
                   <a href="" className="eXnnyV">View job opening</a>
                </div>
            </div>

            <div className="JobInDentDesk-rightSide">
                <img src={Job} alt="" />
            </div>
           </div>
           </div>
