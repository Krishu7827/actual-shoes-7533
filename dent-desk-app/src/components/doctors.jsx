...
useEffect(() => {
  ...
  return (<>
    ...
    (<div className="Doctors">
      ...
      {doctorsForPage.map(({ id, img,Rating, firstName, Role, Address }) => (
          ...
          <div class="sc-hOzowv hhMopY">
            ...
            <div class="sc-ZqFbI ldMTfT">
                <a href="/doctor/john-abraham-md-416658?LocIdent=219772&amp;reason_visit=76&amp;insuranceCarrier=-1&amp;insurancePlan=-1&amp;dr_specialty=153&amp;isNewPatient=true"
                   ...
                   class="sc-fbYMXx mWbpF">{firstName}</a>
            </div>
  ...
  <div class="sc-eYqcxL-dxazRo">
    ...
    <span class="sc-eVspGN cYEBAO">
      <span data-test="doctor-card-info-location-city" itemprop="addressLocality">2353</span>,
      <span data-test="doctor-card-info-location-state" itemprop="addressRegion">{Address.Area}</span>
      <span data-test="doctor-card-info-location-zip" itemprop="postalCode">{Address.Pincode}</span>
    </span>
    </div>
  </div>
</div>
...
<div class="sc-jIILKH GTYGt">
  <div class="sc-ktaQEB imvYwC">
    ...
    <span> • Excellent wait time</span>
        ...
        <div>{<Buttonforbooking Name={firstName} role={Role} rating={Rating} img = {img}/>}</div>
        </div>
      ))}
