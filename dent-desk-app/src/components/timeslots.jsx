...
const Timeslot = (props) => {
  ...
  const {Name,role,rating,selectedDate,img}=props
  console.log(props)
  ...
  const handleTimeSlotClick = (startTime) => {
    ...
    console.log(props)
    const obj={Name,role,rating,selectedDate,Time:startTime,img}
    console.log(obj)
    localStorage.setItem("BookedDoctor",JSON.stringify(obj))
                ...
                <div class="patient-web-app__sc-lxewn3-0 gjnUwl">
                    <div>
                        <picture data-test="doctor-card-photo-picture" class="patient-web-app__sc-nvjjn4-0 bXaHqm">
                            <img alt="Sarah Jirinzu Carratala, MSN, PMHNP-BC" data-test="doctor-card-photo-img" itemprop="image" src={props.img} loading="lazy" class="patient-web-app__sc-13qe5ad-0 jeXWlC"/>
                        </picture>
